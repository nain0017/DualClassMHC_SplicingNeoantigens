...
- **LeafCutter-DS (Python and pyro)** instead of the R and Stan reference LeafCutter (compilation issues on Colab Pro; Dirichlet-multinomial GLM and LRT unchanged) — amendment v5.4.3
- **Mann-Whitney U orthogonal validation** instead of Bisbee (installation failure on Colab Pro; concordance threshold of 80 percent preserved) — amendment v5.4.7
