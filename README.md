...
The complete pipeline was executed on Google Colab Pro (T4 GPU runtime, high-RAM). Software versions are pinned in `requirements.txt` (pip) and `environment.yaml` (conda). Key tools:
...
> Sajid MZ. Splicing-derived dual-class MHC neoantigens in melanoma anti-PD-1 response: a pre-registered three-cohort analysis. (In preparation; preprint pending.)
...
I thank the authors of the Hugo 2016, Riaz 2017, and Gide 2019 cohorts for making raw data publicly available; the authors of LeafCutter (Li et al. 2018), MHCnuggets (Shao et al. 2020), arcasHLA (Orenbuch et al. 2020), recount3 (Wilks et al. 2021), SpliceMutr (Palmer et al. 2024), and the Patterson and Auslander 2022 neoantigen resource for making their tools and derived data publicly available; and Prof. Tapati Basak (Jahangirnagar University) for early-stage advisor input on Paper 1 through Paper 5A of my broader thesis work. The analysis in this repository is the author's own work conducted without institutional affiliation, funding, or high-performance computing access, entirely on Google Colab Pro.
